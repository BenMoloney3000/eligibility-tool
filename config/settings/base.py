...
# Parity Property API
PORTFOLIOS_API_BASE_URL = env.str("PORTFOLIOS_API_BASE_URL")
PORTFOLIOS_API_ID = env.str("PORTFOLIOS_API_ID")
PORTFOLIOS_API_SECRET = env.str("PORTFOLIOS_API_SECRET")

# Postcodes.io API
POSTCODES_IO_API_BASE_URL = env.str("POSTCODES_IO_API_BASE_URL")

# IMD Deciles info API
IMD_DECILES_API_BASE_URL = env.str("IMD_DECILES_API_BASE_URL")
